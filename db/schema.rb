...
ActiveRecord::Schema[8.0].define(version: 2025_08_27_100519) do
  ...
  create_table "reporting_api_vaccination_events", force: :cascade do |t|
    ...
    t.string "patient_school_local_authority_gss_code"
    t.string "patient_school_local_authority_mchlg_code"
