...
ActiveRecord::Schema[8.0].define(version: 2025_03_25_065344) do
  ...
  create_table "patient_session_vaccination_statuses", force: :cascade do |t|
    t.bigint "patient_session_id", null: false
    t.bigint "programme_id", null: false
    t.integer "status", default: 0, null: false
    t.index ["patient_session_id", "programme_id"], name: "idx_on_patient_session_id_programme_id_520c97058b", unique: true
    t.index ["status"], name: "index_patient_session_vaccination_statuses_on_status"
  end
  ...
  add_foreign_key "patient_session_vaccination_statuses", "patient_sessions", on_delete: :cascade
  add_foreign_key "patient_session_vaccination_statuses", "programmes"
