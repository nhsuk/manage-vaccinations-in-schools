...
describe "normalise_whitespace" do
  ...
  describe "patient field normalization" do
    ...
    it "doesn't change already clean data" do
      expect { invoke_task }.not_to(change { patient_with_clean_data })
    end

    it "handles nil values correctly" do
      expect { invoke_task }.not_to(change { patient_with_nil_values })
    end
  ...
  describe "parent field normalization" do
    ...
    it "doesn't change already clean data" do
      expect { invoke_task }.not_to(change { parent_with_clean_data })
    end

    it "handles nil values correctly" do
      expect { invoke_task }.not_to(change { parent_with_nil_name })
    end
