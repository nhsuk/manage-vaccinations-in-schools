...
describe SyncVaccinationRecordJob, type: :job do
  ...
  let(:vaccination_record) do
    instance_double(VaccinationRecord, id: "123", synced_at: nil)
  end
  ...
  context "when the vaccination record has already been synced" do
    let(:vaccination_record) do
      instance_double(VaccinationRecord, id: "123", synced_at: Time.current)
    end
