  ...
  describe "#send_vaccination_discovered_if_required" do
    ...
    context "when vaccination record is not sourced from service" do
      ...
      context "when patient is not considered vaccinated and has valid consents" do
        ...
        it "updates consents with vaccination_record_discovered_sent_at" do
          expect(first_consent.vaccination_record_discovered_sent_at).to be_nil
          expect(second_consent.vaccination_record_discovered_sent_at).to be_nil

          send_vaccination_discovered_if_required

          expect(
            first_consent.reload.vaccination_record_discovered_sent_at
          ).to be_present
          expect(
            second_consent.reload.vaccination_record_discovered_sent_at
          ).to be_present
        end
