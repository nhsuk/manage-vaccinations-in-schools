...
describe Patient do
  ...
  describe "#match_existing" do
    shared_examples "match_existing behavior" do
    ...
    context "when matching against the database" do
      let(:candidates) { nil }

      include_examples "match_existing behavior"
    end

    context "when matching against in-memory candidates" do
      let(:candidates) { [] }
