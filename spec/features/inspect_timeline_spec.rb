...
describe "Inspect timeline" do
  ...
  scenario "User can view graph with support access" do
    given_an_hpv_programme_is_underway
    when_i_sign_in_as_a_support_user
  ...
  scenario "User can't view other pages with support access" do
    given_an_hpv_programme_is_underway
    when_i_sign_in_as_a_support_user
  ...
  scenario "User can't view timeline without support access" do
    given_an_hpv_programme_is_underway
    when_i_sign_in_as_a_nurse
    and_i_go_to_the_timeline_url_for_the_patient
    then_i_see_an_error
  end

  scenario "User can't view graph without support access" do
    given_an_hpv_programme_is_underway
    when_i_sign_in_as_a_nurse
    and_i_go_to_the_graph_url_for_the_patient
    then_i_see_an_error
...
def when_i_sign_in_as_a_nurse
  sign_in @organisation.users.first
end

def when_i_sign_in_as_a_support_user
  sign_in @organisation_support.users.first
end
