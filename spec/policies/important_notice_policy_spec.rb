...
describe ImportantNoticePolicy do
  ...
  describe "#show?" do
    ...
    context "with a notice in the user's team" do
      include_examples "local system admin access"
    end

    context "with a notice in a different team" do
      let(:notice) { create(:important_notice, team_id: create(:team).id) }
