...
:github-branch: reporting-architecture
...
* Users are part of a SAIS team and have restricted access to only those
  campaign and session data owned by their team
* User SAIS team information is retrieved from NHS CIS2
